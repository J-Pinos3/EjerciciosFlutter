      ...
      child: Column(
        children: [
          ...cards.map(
            ...
            /*without the SingleChildScrollView Widget, the cards will overflow the screen
      ...
      child: Stack(
        children: [
          ...
          Container(
            ...
            child: Align(
              alignment: Alignment.bottomLeft,
              child: Text("$label - images and gradient", style: const TextStyle(color: Colors.white),),
            ),
